    ...
    return (
        <>
            <section className="p-6">
                ...
                <p>Si te interesa verlos en acción bailando podes ir directo a la <Link>Galería</Link>.</p>
                <p>En <Link to="/baile">Baile</Link> vas a poder encontrar más información sobre los géneros que abarcan.</p>
                <p>¿Todavía te quedan dudas? En <Link to="/contacto">Contacto</Link> vas a poder escribirnos directamente así resolvemos tus dudas!</p>
